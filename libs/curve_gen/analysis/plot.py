...
from libs.curve_gen.kelly import (probability_from_density, kelly_formula,
                                    kelly_formula_derivative, evaluate_premium_curve)
from libs.curve_gen.payoff.payoff import get_payoff_odds
...
def show(fig):
    ...
    """
    buf = io.BytesIO()
    # pio.write_image(fig, './outputs/figure.png')
    # print('figure saved')
